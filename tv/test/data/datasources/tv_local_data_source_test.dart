...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when insert to database is success', () async {
      // arrange
      when(mockDatabaseHelper.insertWatchlistTvs(testTvTable)).thenAnswer((_) async => 1);
      // act
      final result = await dataSource.insertWatchlistTvs(testTvTable);
      // assert
    ...
    test('should throw DatabaseException when insert to database is failed', () async {
      // arrange
      when(mockDatabaseHelper.insertWatchlistTvs(testTvTable)).thenThrow(Exception());
      // act
      final call = dataSource.insertWatchlistTvs(testTvTable);
      // assert
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success', () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlistTvs(testTvTable)).thenAnswer((_) async => 1);
      // act
      final result = await dataSource.removeWatchlistTvs(testTvTable);
      // assert
    ...
    test('should throw DatabaseException when remove from database is failed', () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlistTvs(testTvTable)).thenThrow(Exception());
      // act
      final call = dataSource.removeWatchlistTvs(testTvTable);
      // assert
      expect(() => call, throwsA(isA<DatabaseException>()));
    });
  });
