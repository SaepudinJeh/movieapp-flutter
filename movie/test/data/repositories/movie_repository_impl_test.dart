...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(mockLocalDataSource.insertWatchlistMovies(testMovieTable)).thenAnswer((_) async => 'Added to Watchlist');
      // act
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource.removeWatchlistMovies(testMovieTable)).thenAnswer((_) async => 'Removed from watchlist');
      // act
