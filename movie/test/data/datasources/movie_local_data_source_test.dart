...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when insert to database is success', () async {
      // arrange
      when(mockDatabaseHelper.insertWatchlistMovies(testMovieTable)).thenAnswer((_) async => 1);
      // act
    ...
    test('should throw DatabaseException when insert to database is failed', () async {
      // arrange
      when(mockDatabaseHelper.insertWatchlistMovies(testMovieTable)).thenThrow(Exception());
      // act
  ...
  group('remove watchlist', () {
    test('should return success message when remove from database is success', () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlistMovies(testMovieTable)).thenAnswer((_) async => 1);
      // act
    ...
    test('should throw DatabaseException when remove from database is failed', () async {
      // arrange
      when(mockDatabaseHelper.removeWatchlistMovies(testMovieTable)).thenThrow(Exception());
      // act
